...
const services = [
  {
    ...
    description:
      "AWS, GCP, and Azure — designed for scale, security, and cost control.",
    link: "/devops-consulting",
    linkText: "DevOps consulting services →"
  },

  {
    ...
    description:
      "Reduce cloud spend with right-sizing, auto-scaling, and efficient resource utilization.",
    link: "/aws-cost-optimization",
    linkText: "Reduce AWS costs →"
  },

  {
    ...
    description:
      "Production-grade K8s clusters + Docker for high availability.",
    link: "/kubernetes-scaling",
    linkText: "Kubernetes scaling optimization →"
  },

  {
    ...
    title: "DevSecOps",
    description:
      "Zero-trust networking, secrets management, and audit-ready infrastructure."
  },

  {
    ...
    title: "Observability",
    description:
      "Full-stack monitoring, logging, and alerting with Datadog, Grafana, and more."
  },

  {
    ...
    description:
      "Terraform and Pulumi modules that make infrastructure reproducible.",
    link: "/ci-cd-automation",
    linkText: "CI/CD pipeline automation →"
  },

  {
    ...
    description:
      "24/7 monitoring & rapid issue resolution."
  },
